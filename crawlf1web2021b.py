...
class Crawlf1web2021b:
    ...
    def __init__(self, drivers_html_path, race_classification_path, practice1_path, practice2_path, 
                sprint_grid_path, sprint_path, q1_path, q2_path, q3_path, q1_laptimes_path, q2_laptimes_path, q3_laptimes_path,starting_grid_path, driver_standings_path, teams_standings_path,
        ...
        self.sprint_grid_path = sprint_grid_path
    ...
    def load(self):
        ...
        self.parseGrid("SprintGrid",self.sprint_grid_path,self.sprint_grid)
        self.parseGrid("SprintRace",self.sprint_path,self.sprint)
